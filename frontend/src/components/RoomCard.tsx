...
// MODIFIED: Added MapPin icon
import { Users, Wifi, Monitor, Volume, Coffee, Building2, Clock, CalendarCheck, MapPin } from "lucide-react";
    ...
    >
      ...
      <CardContent className="space-y-5 p-6 relative z-10 flex flex-col flex-grow"> {/* Added flex flex-col flex-grow here */}
        <div className="space-y-3">
          ...
          {/* --- MODIFIED: Added Location and updated Capacity description --- */}
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
            <CardDescription className="text-sm sm:text-base text-gray-300 group-hover:text-gray-200 flex items-center gap-2 transition-colors duration-300">
              <MapPin size={18} className="text-purple-400 group-hover:text-purple-300 transition-colors duration-300" />
